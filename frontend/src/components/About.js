            ...
            <section id="about" className="tm-section">
                ...
                <div className="row tm-row-about">
                    ...
                    <div className="tm-col-about tm-col-about-r">
                        <img src="assets/img/img-about-01.jpg" alt="about" className="img-fluid mb-5 tm-img-about"></img>
                        <p>
                ...
                <div className="mt-5">
                    <div className="tm-carousel">
                        ...
                        <div className="tm-carousel-item">
                            ...
                            <div className="tm-about-text">
                                <h3 className="mb-3 tm-text-primary tm-about-title">Calvin Third</h3>
                                <p>Aliquam efficitur, velit ut aliquet molestie, nulla dolor faucibus neque, quis hendrerit.</p>
                                <h4 className="tm-text-secondary tm-about-subtitle">Designer</h4>
                            </div>
                        </div>
                        ...
                        <div className="tm-carousel-item">
                            ...
                            <div className="tm-about-text">
                                <h3 className="mb-3 tm-text-primary tm-about-title">Jenifer Third</h3>
                                <p>This is a carousel for a list of 10 team members. Each member image hover has 3 social icons.</p>
                                <h4 className="tm-text-secondary tm-about-subtitle">Program Director</h4>
                            </div>
                        </div>
                        ...
                        <div className="tm-carousel-item">
                            ...
                            <div className="tm-about-text">
                                <h3 className="mb-3 tm-text-primary tm-about-title">David Three</h3>
                                <p>Aliquam efficitur, velit ut aliquet molestie, nulla dolor faucibus neque, quis hendrerit.</p>
                                <h4 className="tm-text-secondary tm-about-subtitle">Financial Assistant</h4>
                            </div>
                        </div>
                        ...
                        <div className="tm-carousel-item">
                            ...
                            <div className="tm-about-text">
                                <h3 className="mb-3 tm-text-primary tm-about-title">Calvin Four</h3>
                                <p>Aliquam efficitur, velit ut aliquet molestie, nulla dolor faucibus neque, quis hendrerit.</p>
                                <h4 className="tm-text-secondary tm-about-subtitle">Media Partner</h4>
                            </div>
                        </div>
                    </div>
                </div>
